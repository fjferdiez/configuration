...
ENVIRONMENT_DEPLOYMENTS=${ENVIRONMENT_DEPLOYMENTS:=stage-edx}
PLAYS=${PLAYS:=edxapp,veda_web_frontend,analyticsapi,credentials,journals,ecommerce,discovery,ecomworker,insights,notifier,registrar}
